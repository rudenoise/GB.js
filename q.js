...
Q = (function (Q, recursive) {
    ...
    Q.isDOM = function (node) {
        var regCheck = new RegExp("Element]$");
        return Object.prototype.toString.call(node).match(regCheck) !== null;
    };
    ...
    if (recursive !== false) {
        ...
        Q.inArr = function (item, arr) {
            return Q.isEmptyArr(arr) ?                      
                false :                                     
                Q.h(arr) === item ?
                   true : Q.inArr(Q.t(arr));
        };  
    } else {
        Q.same = function () {
